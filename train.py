...
>>>>>>> f131a1d52e562e36a2abb8996722b92af7918ac7
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if save:
            ...
            # Save backup every 40 epochs (optional)    #最後儲存權重名稱，每 ? epochs儲存
...
if __name__ == '__main__':
    ...
    parser.add_argument('--accumulate', type=int, default=2, help='accumulate gradient x batches before optimizing')
