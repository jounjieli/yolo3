...
python test.py --weights ../darknet/backup/yolov3.backup
...
<<<<<<< HEAD:weights/gcp.sh
python train.py --nosave --data data/coco_1img.data && mv results.txt results3_1img.txt
python train.py --nosave --data data/coco_10img.data && mv results.txt results3_10img.txt
python train.py --nosave --data data/coco_100img.data && mv results.txt results4_100img.txt
python train.py --nosave --data data/coco_100img.data --transfer && mv results.txt results3_100imgTL.txt
...
>>>>>>> f131a1d52e562e36a2abb8996722b92af7918ac7:utils/gcp.sh
...
git clone https://github.com/ultralytics/yolov3  # master
cp -r weights yolov3  && cd yolov3
python detect.py  # detect
python test.py --data data/coco_32img.data  # test
python train.py --data data/coco_32img.data --epochs 5 --nosave  # train
...
cp -r cocoapi/PythonAPI/pycocotools yolov3
cp -r weights yolov3 && cd yolov3
python train.py --evolve --data data/coco_100img.data --num-workers 2  --epochs 30
=======
