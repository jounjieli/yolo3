...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        # Augment image and labels   #數據增強調整
        if self.augment:
            img, labels = random_affine(img, labels, degrees=(-15, 15), translate=(0.2, 0.2), scale=(0.4, 1.6),shear=(-4,4))
